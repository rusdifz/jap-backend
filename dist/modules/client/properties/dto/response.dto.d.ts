import { LocationEnum, IMedia, IProperty, Unit, PropertyStatusEnum, PropertyTypeEnum } from 'src/common';
...
export declare class ResProperties implements Partial<IProperty> {
    property_id: number;
    name: string;
    slug: string;
    location?: LocationEnum;
